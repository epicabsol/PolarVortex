...
GLFWGamepadDevice::GLFWGamepadDevice(int joystickID) : _JoystickID(joystickID), _State(), _Sprite(RootAllocator.New<GLTexture>(STRINGHASH("assets/sprites/controls/xbox/controller.png"))) {
